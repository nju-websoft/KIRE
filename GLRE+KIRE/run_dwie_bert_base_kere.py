...
config_path = './configs/dwie_basebert_62.9.yaml'
output_path = './results/dwie-dev/dwie_basebert_kere/'
kg_config_path = './knowledge_injection_layer/kgconfigs/dwie_bert_kg.yaml'
