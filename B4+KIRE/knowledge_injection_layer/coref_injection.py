...
class Coref_Injection(nn.Module):
    ...
    def _forward(self, head, tail, lens, input, coref_mention_position, coref_label, diss=None):
        """
    ...
    def forward(self, head, tail, lens, input, coref_mention_position, coref_label, coref_label_mask):
        ...
        encoded_seq, predict_coref = self._forward(head, tail, lens, input, coref_mention_position, coref_label)
