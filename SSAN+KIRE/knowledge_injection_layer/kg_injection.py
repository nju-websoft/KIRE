...
class Kg_Injection(nn.Module):
    ...
    def forward(self, entity_attrs, attrs_nums, entity_attr_lens, kg_adj, entity_doc_nodeid, doc_hidden_states, doc_reps, attention_mask, attention_mask_ent, kg_ent_labels, kg_adj_edges, kg_radj):
        """
        ...
        kg_input_ent, kg_candicate = self.kg_encoder(entity_attrs, attrs_nums,
                                                     ...
                                                     entity_doc_nodeid, kg_adj_edges, kg_radj)
        # t2 = time.time()
