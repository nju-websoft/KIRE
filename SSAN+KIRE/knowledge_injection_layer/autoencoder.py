...
class Dataset(object):
    ...
    def next_batch(self, batch_size, train=False):
        ...
        if self.next_batch_ind >= last_ml:
            ...
            if self.last_matrix_ind >= len(self.sentence_matrices):  # 每个epoch 后随机
                if train:
...
def prepare_data1():
    ...
    id2word = {v:k for k,v in word2id.items()}
    new_sents = []
    for sents_file, lens_file in [('../../kg_data/dev_train_kg_subg_entity_attrs1.npy', '../../kg_data/dev_train_kg_subg_entity_attr_lens1.npy'),
                                  ('../../kg_data/dev_dev_kg_subg_entity_attrs1.npy', '../../kg_data/dev_dev_kg_subg_entity_attr_lens1.npy'),
                                  ('../../kg_data/dev_test_kg_subg_entity_attrs1.npy', '../../kg_data/dev_test_kg_subg_entity_attr_lens1.npy')]:
